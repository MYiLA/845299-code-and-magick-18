...
window.renderStatistics = function (ctx, names, times) {
  ...
  for (var i = 0; i < names.length; i++) {
    if (names[i] === 'Вы') {
      ...
      ctx.fillStyle = 'hsl(238 ,' + 360 * Math.random() + '%, 50%)';
    }
...
// при решении задачи мы не рассмотрели случая, когда длины массивов players и times не будут совпадать.
// Для этого вам нужно принять решение, как поступать с лишними или недостающими элементами в массивах.
// Или убирать лишние значения, для которых нет пары или придумывать стандартные значения,
// которыми можно дополнить массив.
